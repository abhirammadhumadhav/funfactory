  ...
  Widget build(BuildContext context) {
        return Row(
          ...
          children: [
            ElevatedButton.icon(
              onPressed: () async {
                if (widget.productId != null) {  // Check if productId is not null
                  print('Fetching product with productId: ${widget.productId}');  // Print the productId
                   
                  final productDocument = await FirebaseFirestore.instance.collection('product').doc(widget.productId) .get();
              ...
              style: ButtonStyle(
                ...
                backgroundColor: MaterialStateProperty.all(isProductAdded ? Colors.blue: Colors.green),
